...
```{r logfoldchange, message=FALSE, cache = FALSE}
...
```{r logmean, message=FALSE, warning=FALSE, cache = FALSE}
...
```{r logfoldchangeFit, cache=FALSE}
...
```{r contour-plot, eval=TRUE, cache = FALSE}
...
```{r sim_multi_ss, eval = TRUE, cache = FALSE}
nsim = 4
...
```{r deseq_multi_ss, eval = TRUE, cache = FALSE}
desq_est_list  =  list()
...
```{r gam_multi_ss, eval = FALSE, cache = FALSE}
