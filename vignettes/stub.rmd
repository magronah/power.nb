...
We would also like to thank the following students for the University of Alberta who took time to run the functions in this package to estimates the parameters in the table in the appendix for the vairous datasets: 
Nevin Nu, Mir Akbaar, Gosh, George, Alim, Akja, etc. 
